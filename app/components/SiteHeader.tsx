  ...
  return (
    <header className='flex items-center justify-between gap-6'>
      <Link href='/' className='group flex items-center gap-3'>
        <span className='inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/15 bg-black/60'>
          <Image src='/appstore.png' alt='Fidget Doodle logo' width={38} height={38} className=' object-cover rounded-full' priority />
        </span>
        <span className='text-lg font-semibold tracking-[0.12em] text-white/90'>FIDGET DOODLE</span>
      </Link>
